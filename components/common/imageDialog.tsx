...
const ImageDialog = ({ isOpen, setIsOpen, data }: any) => {
  const prompt = data.content.replaceAll("*", "").replaceAll(/ *\([^)]*\) */g, "").replaceAll(/ - .*@.*/g, "")
  return (
    <>
      <Transition.Root
        show={isOpen}
      ...
      >
        <Dialog
          as="div"
          static
          className="fixed z-90 inset-0 overflow-y-auto"
        ...
        >
          <div className="flex items-center justify-center min-h-screen text-center sm:block sm:p-0">
            ...
            >
              <div className="relative rounded-3xl border-4 border-orange-500 inline-block align-bottom text-left overflow-hidden transform transition-all sm:align-middle sm:max-w-xl sm:w-full">
