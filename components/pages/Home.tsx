    ...
    const data = await axios.get(
      `https://discord.com/api/v9/guilds/662267976984297473/messages/search?content=${searchText}${pageOffset}`,
      {
        headers: {
          accept: '*/*',
          authorization:
            'MTA2ODkzMTMzMTg2NzgyNDE5OQ.GF0TrH.yYe8Hv_jGk-a2s7oQuJvQwqWVjbvFy5aDJKyjM',
          'x-super-properties':
            ''
        }
      }
    )
